...
import ArchiveServiceCard from "./ArchiveServiceCard";
import Pagination from "src/Components/global/Pagination/Pagination";
import Loader from "src/Components/UI/Loader/Loader";

function ArchiveService({ dataLimit = 10 }) {
  ...
  const getListServices = async () => {
    try {
      setLoading(true)
      const { data } = await axios.get(`my/services/archive/?index=${startIndex}&offset=${endIndex}`)
      // console.log(data)
